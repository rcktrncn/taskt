...
namespace taskt.Core.Automation.Commands
{
    ...
    public sealed class ReplaceDataTableRowValueCommand : ADataTableRowCommands, ILReplaceValueProperties, IHaveDataTableElements
    {
        //[XmlAttribute]
        ...
        public override void RunCommand(Engine.AutomationEngineInstance engine)
        {
            ...
            (var targetDT, var rowIndex) = this.ExpandValueOrUserVariableAsDataTableAndRow(engine);
